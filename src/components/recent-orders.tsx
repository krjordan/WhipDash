...
import { RefreshCw, ShoppingCart, User } from 'lucide-react'
import { Card, CardContent, CardHeader, CardTitle } from '@/components/ui/card'
import { useSession } from '@/lib/session-context'

export function RecentOrders() {
	const { sessionState, shopifyData, refreshShopifyData } = useSession()
	...
	const ordersToDisplay = React.useMemo(() => {
		...
		// When session is not started or we have errors, show empty
		return []
	}, [
		sessionState.isStarted,
		shopifyData.lastUpdated,
	...
	return (
		<Card className="col-span-4">
				...
				<div className="flex items-center justify-between">
					<div>
						...
						<p className="text-sm text-muted-foreground mt-1">
							...
							shopifyData.lastUpdated &&
							!shopifyData.error
								? `${shopifyData.orderCount} orders in the last 7 days`
			...
			<CardContent>
				{shopifyData.error && sessionState.isStarted && (
